    ...
    <div class="content_resize">
        <div class="mainbar">
            <div class="article">
                ...
                <div class="clr"></div>
                <div class="img"><img src="<?=$config['base']['url']; ?>/images/img1.jpg" width="630" height="221" alt="" class="fl" /></div>
            ...
            <div class="article">
                ...
                <div class="clr"></div>
                <div class="img"><img src="<?=$config['base']['url']; ?>/images/img2.jpg" width="630" height="221" alt="" class="fl" /></div>
                <div class="post_content">
